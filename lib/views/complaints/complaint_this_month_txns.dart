...
class ComplaintThisMonthTxns extends StatefulWidget {
  const ComplaintThisMonthTxns({Key? key}) : super(key: key);

  @override
  State<ComplaintThisMonthTxns> createState() => _ComplaintThisMonthTxnsState();
}

class _ComplaintThisMonthTxnsState extends State<ComplaintThisMonthTxns> {
  ...
  void initState() {
    ...
    BlocProvider.of<ComplaintCubit>(context).getHistoryDetails('This Month');
    ...
    return Scaffold(
      ...
      body: BlocConsumer<ComplaintCubit, ComplaintState>(
        ...
        builder: (context, state) {
          ...
          return ComplaintThisMonthTxnsUI(
...
class ComplaintThisMonthTxnsUI extends StatefulWidget {
  ...
  @override
  State<ComplaintThisMonthTxnsUI> createState() =>
      _ComplaintThisMonthTxnsUIState();
}

class _ComplaintThisMonthTxnsUIState extends State<ComplaintThisMonthTxnsUI> {
