...
class ComplaintLastMonthTxns extends StatefulWidget {
  ...
  @override
  State<ComplaintLastMonthTxns> createState() => _ComplaintLastMonthTxnsState();
}

class _ComplaintLastMonthTxnsState extends State<ComplaintLastMonthTxns> {
  ...
  void initState() {
    ...
    BlocProvider.of<ComplaintCubit>(context).getHistoryDetails('Last Month');
    ...
    return Scaffold(
      ...
      body: BlocConsumer<ComplaintCubit, ComplaintState>(
        ...
        builder: (context, state) {
          ...
          return ComplaintLastMonthTxnsUI(
...
class ComplaintLastMonthTxnsUI extends StatefulWidget {
  ...
  @override
  State<ComplaintLastMonthTxnsUI> createState() =>
      _ComplaintLastMonthTxnsUIState();
}

class _ComplaintLastMonthTxnsUIState extends State<ComplaintLastMonthTxnsUI> {
