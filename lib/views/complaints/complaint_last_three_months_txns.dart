...
class ComplaintLastThreeMonthTxns extends StatefulWidget {
  const ComplaintLastThreeMonthTxns({Key? key}) : super(key: key);

  @override
  State<ComplaintLastThreeMonthTxns> createState() =>
      _ComplaintLastThreeMonthTxnsState();
}

class _ComplaintLastThreeMonthTxnsState
    extends State<ComplaintLastThreeMonthTxns> {
  ...
  void initState() {
    ...
    BlocProvider.of<ComplaintCubit>(context).getHistoryDetails('last 3 Months');
...
// Listing all transactions
        ...
        builder: (context, state) {
          ...
          return ComplaintLastThreeMonthTxnsUI(
...
class ComplaintLastThreeMonthTxnsUI extends StatefulWidget {
  ...
  @override
  State<ComplaintLastThreeMonthTxnsUI> createState() =>
      _ComplaintLastThreeMonthTxnsUIState();
}

class _ComplaintLastThreeMonthTxnsUIState
    extends State<ComplaintLastThreeMonthTxnsUI> {
