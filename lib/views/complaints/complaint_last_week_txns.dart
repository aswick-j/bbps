...
class ComplaintLastWeekTxns extends StatefulWidget {
  const ComplaintLastWeekTxns({Key? key}) : super(key: key);

  @override
  State<ComplaintLastWeekTxns> createState() => _ComplaintLastWeekTxnsState();
}

class _ComplaintLastWeekTxnsState extends State<ComplaintLastWeekTxns> {
  ...
  void initState() {
    ...
    BlocProvider.of<ComplaintCubit>(context).getHistoryDetails('Last Week');
...
// Listing all transactions
        ...
        builder: (context, state) {
          ...
          return ComplaintLastWeekTxnsUI(
...
class ComplaintLastWeekTxnsUI extends StatefulWidget {
  ...
  @override
  State<ComplaintLastWeekTxnsUI> createState() =>
      _ComplaintLastWeekTxnsUIState();
}

class _ComplaintLastWeekTxnsUIState extends State<ComplaintLastWeekTxnsUI> {
