...
class ComplaintTodayTxns extends StatefulWidget {
  const ComplaintTodayTxns({Key? key}) : super(key: key);

  @override
  State<ComplaintTodayTxns> createState() => _ComplaintTodayTxnsState();
}

class _ComplaintTodayTxnsState extends State<ComplaintTodayTxns> {
  ...
  void initState() {
    ...
    BlocProvider.of<ComplaintCubit>(context).getHistoryDetails('Today');
...
class ComplaintTodayTxnsUI extends StatefulWidget {
  ...
  @override
  State<ComplaintTodayTxnsUI> createState() => _ComplaintTodayTxnsUIState();
}

class _ComplaintTodayTxnsUIState extends State<ComplaintTodayTxnsUI> {
