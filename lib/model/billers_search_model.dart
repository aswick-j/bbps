// class BillersSearchModel {
//   int? status;
//   String? message;
//   List<SearchResultsData>? data;

//   BillersSearchModel({this.status, this.message, this.data});

//   BillersSearchModel.fromJson(Map<String, dynamic> json) {
//     status = json['status'];
//     message = json['message'];
//     if (json['data'] != null) {
//       data = <SearchResultsData>[];
//       json['data'].forEach((v) {
//         data!.add(new SearchResultsData.fromJson(v));
//       });
//     }
//   }
...
//   SearchResultsData.fromJson(Map<String, dynamic> json) {
